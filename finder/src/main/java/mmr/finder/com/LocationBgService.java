...
public class LocationBgService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,LocationListener {
    ...
    private final String TAG = mmr.finder.com.LocationBgService.class.getSimpleName();
    ...
    public void onLocationChanged(Location location) {
        ...
        if(location!=null) {
            mmr.finder.com.PreferenceUtil.getInstance(this).saveLastKnownLocation(location);
